    ...
    <div class="mainForm">
        <form method="POST">
            ...
            <div class="container">
                ...
                <div>
                    <h1 class="Heading">  Invoice <br />Registration </h1>
                </div><br>
                <table>
                    <tr>
                    ...
                    <tr>
                        ...
                        <td><select name="Product" class="input">
                    ...
                    <tr>
                        ...
                        <td><input type="Date" name="Date" class="input" min="<?= date('Y-m-d'); ?>"> <br /></td>
                    </tr>
        ...
        <div align="center">
            ...
            <table border="2px">
                ...
                <tr>
                    ...
                    <td><button type="button" class="btn btn-info btn-lg" data-toggle="modal" data-target=<?php echo "#myModal".$res["Id"]; ?>>View More</button></td>
                    <div class="modal fade" id=<?php echo "myModal".$res["Id"]; ?> role="dialog">
                        ...
                        <div class="modal-content">
                            ...
                            <a style="text-decoration:none; padding:10px 20px; background-color:tomato; color:white; border-radius:15px;" href="display.php?Id=<?php echo $res['Id']; ?>"> Invoice</a>
